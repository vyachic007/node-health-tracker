...
@Component
public class HttpsChecker implements ServiceChecker {
    ...
    public CheckProbeResult check(NetworkService service) {
        try {
            Integer httpStatusCode = executeHttpsRequest(service);
    ...
    private Integer executeHttpsRequest(NetworkService service) throws Exception {
