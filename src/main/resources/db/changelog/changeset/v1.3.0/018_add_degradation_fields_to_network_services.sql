...
--rollback ALTER TABLE DROP COLUMN response_time_threshold_ms;
--rollback ALTER TABLE DROP COLUMN degradation_threshold;
--rollback ALTER TABLE DROP COLUMN consecutive_degradations;